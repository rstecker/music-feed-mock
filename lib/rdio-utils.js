...
(function(R) {
  ...
  window.rdioUtils = {
    ...
    formatSeconds: function(s) {
      var time = this._secondsToTime(s);
      return (time.hours >= 1 ? time.hours + ":" : "") +
        (time.hours >= 1 ? this.zeroPad(time.minutes) + ":" : (time.minutes >= 1 ? time.minutes + ":" : "0:")) +
        this.zeroPad(time.seconds);
    }
  };
