...
window.ColorPicker.prototype = {
  ...
  printValidColors: function() {
    console.log(" -- starting print valid colors : "+new Date())
    var all_colors = {};
    var reduced_colors = [];
    for (var r = 0; r <= 255; r += 10){
      for (var g = 0; g <= 255; g += 10){
        for (var b = 0; b <= 255; b += 10){
          ...
          if (tempr < 16) tempr = '0' + r.toString(16);
          else tempr = tempr.toString(16);
          if (tempg < 16) tempg = '0' + g.toString(16);
          else tempg = tempg.toString(16);
          if (tempb < 16) tempb = '0' + b.toString(16);
          else tempb = b.toString(16);
          color = tempr + tempg + tempb;
    ...
    this.printColorSet(_.keys(reduced_colors), $('.color_console .legal_colors'))
  },
